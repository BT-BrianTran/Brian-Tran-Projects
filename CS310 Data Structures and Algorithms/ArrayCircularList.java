...
public class ArrayCircularList<E> {
	...
	public boolean addFirst(E obj) {
		...
		if (front == -1) { // wrap front to end of array
	...
	public boolean addLast(E obj) {
		...
		if (rear == array.length) { // wrap rear to beginning of array
			rear = 0;
		}
	...
	public E removeFirst() {
		...
		if (front == array.length) { // wrap front to beginning of array
			front = 0;
		}
	...
	public E removeLast() {
		...
		if (rear == -1) { // wrap rear to end of array 
			rear = array.length - 1;
		}
	...
	public E remove(E obj) {
		...
		if (contains(obj)) {
			...
			element = array[indexFound]; // case where you remove in middle and have to shift
			for (int i = indexFound; i != rear; i++) { 
				if (i == array.length - 1) { // wrap to start of array 
					array[i] = array[0];
					i = -1; 
				}
				else {
